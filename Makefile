...
make_pseudo_multi_label_multi_classification_data_on_gold: $(PSEUDO_MSMLC_DATA_ON_GOLD)
	@echo $(PSEUDO_MSMLC_DATA_ON_GOLD)
...
train_on_few_shot: $(TRAIN_ON_FEW_SHOT)
	@echo TRAIN_ON_FEW_SHOT: $(TRAIN_ON_FEW_SHOT)
...
eval_flatten_marginal_softmax: $(EVAL_FLATTEN_MARGINAL_MSMLC_OUT)
	@echo EVAL_FLATTEN_MARGINAL_MSMLC_OUT: $(EVAL_FLATTEN_MARGINAL_MSMLC_OUT)