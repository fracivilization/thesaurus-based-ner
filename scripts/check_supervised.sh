get_make_cmd () {
    CMD="MSC_O_SAMPLING_RATIO=${MSC_O_SAMPLING_RATIO} TRAIN_SNT_NUM=${TRAIN_SNT_NUM} O_SAMPLING_RATIO=${O_SAMPLING_RATIO} NEGATIVE_CATS=\"${NEGATIVE_CATS}\" WITH_O=${WITH_O} FIRST_STAGE_CHUNKER=${FIRST_STAGE_CHUNKER} make"
    echo ${CMD}
}
