TERM2CATS := $(TERM2CATS_DIR)/$(firstword $(shell echo  "TERM2CATS" "KNOWLEDGE_BASE: $(KNOWLEDGE_BASE)" "REMAIN_COMMON_SENSE_FOR_TERM2CATS: $(REMAIN_COMMON_SENSE_FOR_TERM2CATS)" | sha1sum)).pkl
