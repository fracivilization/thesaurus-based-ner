...
EVAL_FLATTEN_MARGINAL_MSMLC_OUT := outputs/$(firstword $(shell echo "TRAIN_AND_EVAL_MSMLC_OUT" $(EVAL_ARGS) $(PSEUDO_MSMLC_DATA_ON_GOLD) $(PSEUDO_ON_GOLD_TRAINED_MSMLC_MODEL) $(POSITIVE_CATS) $(NEGATIVE_CATS) | sha1sum))
EVAL_FLATTEN_MARGINAL_MSMLC_ON_GOLD_OUT := outputs/$(firstword $(shell echo "TRAIN_AND_EVAL_MSMLC_OUT" $(EVAL_ARGS) $(GOLD_TRAIN_MSMLC_DATA) $(GOLD_TRAINED_MSMLC_MODEL) $(POSITIVE_CATS) $(NEGATIVE_CATS) | sha1sum))