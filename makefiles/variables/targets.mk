...
TERM2CAT := $(TERM2CAT_DIR)/$(firstword $(shell echo  "TERM2CAT" "FOCUS_CATS: $(FOCUS_CATS)" "NEGATIVE_CATS: $(NEGATIVE_CATS)" | sha1sum)).pkl
TERM2CATS := $(TERM2CATS_DIR)/$(firstword $(shell echo  "TERM2CATS" "KNOWLEDGE_BASE: $(KNOWLEDGE_BASE)" | sha1sum)).pkl
