...
EVAL_BATCH_SIZE ?= 32
# For latent label
USE_LATENT_LABEL ?= False
LATENT_LABEL_DIM ?= 50
WEIGHT_FOR_LATENT_LABEL ?= 0.1



MSC_ARGS := "WITH_O: $(WITH_O) FIRST_STAGE_CHUNKER: $(FIRST_STAGE_CHUNKER) NEGATIVE_RATIO_OVER_POSITIVE: $(NEGATIVE_RATIO_OVER_POSITIVE)"
MSMLC_ARGS := "FIRST_STAGE_CHUNKER: $(FIRST_STAGE_CHUNKER) UNDERSAMPLE_MSLC: $(UNDERSAMPLE_MSLC) MSMLC_PN_RATIO_EQUIVALENCE: $(MSMLC_PN_RATIO_EQUIVALENCE) MSMLC_NEGATIVE_RATIO_OVER_POSITIVE: $(MSMLC_NEGATIVE_RATIO_OVER_POSITIVE) MSMLC_DYNAMIC_PN_RATIO_EQUIVALENCE: $(MSMLC_DYNAMIC_PN_RATIO_EQUIVALENCE) USE_LATENT_LABEL: $(USE_LATENT_LABEL) LATENT_LABEL_DIM: $(LATENT_LABEL_DIM) WEIGHT_FOR_LATENT_LABEL: $(WEIGHT_FOR_LATENT_LABEL)"
