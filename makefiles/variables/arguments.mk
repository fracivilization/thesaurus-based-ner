...
NEGATIVE_CATS ?= $(shell poetry run python -m cli.preprocess.load_negative_categories --focus-categories $(subst $() ,_,$(FOCUS_CATS)) --with-negative_categories $(WITH_NEGATIVE_CATEGORIES))
# WITH_NC ?= True
WITH_O ?= True
